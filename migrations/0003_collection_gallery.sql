...
WHERE NOT EXISTS (SELECT 1 FROM page_blocks WHERE id='home-block-hero');
INSERT INTO page_blocks (id,page_id,type,sort_order,data)
...
WHERE NOT EXISTS (SELECT 1 FROM page_blocks WHERE id='home-block-intro');
INSERT INTO page_blocks (id,page_id,type,sort_order,data)
...
WHERE NOT EXISTS (SELECT 1 FROM page_blocks WHERE id='home-block-image');
INSERT INTO page_blocks (id,page_id,type,sort_order,data)
SELECT 'home-block-stories','page-home','blog',3,'{"eyebrow":"Selected Stories","title":"Recent celebrations"}'
WHERE NOT EXISTS (SELECT 1 FROM page_blocks WHERE id='home-block-stories');
INSERT INTO page_blocks (id,page_id,type,sort_order,data)
...
WHERE NOT EXISTS (SELECT 1 FROM page_blocks WHERE id='home-block-contact');
...
WHERE NOT EXISTS (SELECT 1 FROM page_blocks WHERE id='about-block-intro');
INSERT INTO page_blocks (id,page_id,type,sort_order,data)
SELECT 'about-block-image','page-about','image',1,'{"image_url":"/images/studio/scene-studio.jpg","alt":"The Scene Studio"}'
WHERE NOT EXISTS (SELECT 1 FROM page_blocks WHERE id='about-block-image');
INSERT INTO page_blocks (id,page_id,type,sort_order,data)
...
WHERE NOT EXISTS (SELECT 1 FROM page_blocks WHERE id='about-block-values');
