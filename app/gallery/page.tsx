...
type CollectionRow = { id:string;title:string;slug:string;client_name:string|null;destination_name:string|null;destination_slug:string|null;destination_country:string|null;cover_path:string|null;cover_position_x:number|null;cover_position_y:number|null;media_count:number };
