    ...
    <main className="min-h-screen bg-[#f7f5f0] text-[#171717]">
      <header className="sticky top-0 z-40 border-b border-black/10 bg-[#f7f5f0]/95 px-5 py-5 backdrop-blur-md md:px-8">
        <div className="mx-auto flex max-w-[1500px] items-center justify-between gap-6">
          <div><a href="/admin" className="font-sans text-[9px] uppercase tracking-[0.28em] opacity-45 hover:opacity-100">← Admin</a><h1 className="mt-2 font-serif text-4xl tracking-[-0.045em] md:text-5xl">Media</h1></div>
      ...
      <section className="mx-auto max-w-[1500px] px-5 py-8 md:px-8 md:py-12">
        ...
        {loading ? <div className="py-28 text-center font-sans text-[10px] uppercase tracking-[0.2em] opacity-40">Loading media…</div> : filtered.length === 0 ? <div className="border border-dashed border-black/15 py-28 text-center font-serif text-3xl opacity-35">No media found.</div> : (
