...
export default function AdminCollectionsPage() {
  ...
  return <main className="min-h-screen bg-[#f7f5f0] px-6 py-12 text-[#171717]"><div className="mx-auto max-w-7xl"><div className="flex items-end justify-between gap-6"><div><p className="text-xs uppercase tracking-[0.2em] text-[#77736c]">Gallery</p><h1 className="mt-3 font-serif text-5xl tracking-[-0.04em]">Collections</h1><p className="mt-3 max-w-xl text-sm text-[#77736c]">Manage the gallery collections and the editorial content shown above them.</p></div><Link href="/admin/gallery/new" className="bg-[#171717] px-6 py-3 text-xs uppercase tracking-[0.15em] text-white">+ New Collection</Link></div>

  {message && <div className="mt-8 border border-[#d8d3ca] bg-white px-5 py-4 text-sm text-[#666158]">{message}</div>}
